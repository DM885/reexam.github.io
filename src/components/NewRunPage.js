...
class NewRunPage extends React.Component {
  ...
  async save() {
    ...
    const solverCheck = data.solvers.some(
      (d) => !d.solverID || d.solverID === -1
    );
    if (data.model === 0) {
    ...
    return (
      <div className="container pt-4">
            ...
            <div className="row">
              ...
              <div className="col-sm-8">
                <input
                  ...
                  min="1"
                  onChange={(e) =>
                    this.updateSolver("cpuLimit", Number(e.target.value), key)
                  }
                  // eslint-disable-next-line react/jsx-no-duplicate-props
                  //min="0"
              ...
              <div className="col-sm-8">
                <input
                  type="number"
                  onChange={(e) =>
                    this.updateSolver("timeLimit", Number(e.target.value), key)
                  }
                  min="0"
        ...
        <div className="btn-group mr-2" role="group">
          <button onClick={() => this.save()} className="btn btn-primary mt-2">
            Save
          </button>
          <button
